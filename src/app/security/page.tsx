...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "OFFSCRIPT's vulnerability disclosure policy, how we protect client data during security engagements, and what our VAPT and penetration testing reports contain.",
  path: "/security",
  image: "cybersecurity",
});
        ...
        aside={
          <div className="panel-feature panel-edge flex flex-col gap-4 rounded-xl p-6 lg:w-[320px]">
            ...
            <a
              ...
              className="min-h-[40px] items-center text-ink-soft hover:text-ink inline-flex cursor-pointer items-center gap-2 py-1.5 t-sm underline underline-offset-4"
            >
