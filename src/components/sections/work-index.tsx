  ...
  return (
    ...
    >
        ...
        {studies.map((study, index) => (
          <li key={study.slug}>
            <Link
              ...
              className="group grid cursor-pointer grid-cols-[auto_1fr_auto] items-center gap-5 border-b border-[rgba(11,12,10,0.16)] py-7 transition-colors duration-300 ease-out md:gap-10 md:py-10"
            >
              <span
      ...
      <div
        ...
        aria-hidden="true"
        className={cn(
          "work-preview pointer-events-none fixed z-40 hidden w-[260px] rounded-2xl border border-[rgba(11,12,10,0.2)] p-5 shadow-[0_24px_60px_-20px_rgba(12,14,10,0.35)] lg:block",
